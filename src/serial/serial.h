...
#define IOCTL_SERIALP_GET_SAMPLE_RATE		CTL_CODE(FILE_DEVICE_SERIAL_PORT,41,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_RX_TRIGGER		CTL_CODE(FILE_DEVICE_SERIAL_PORT,42,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_TX_TRIGGER		CTL_CODE(FILE_DEVICE_SERIAL_PORT,43,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_AUTO485			CTL_CODE(FILE_DEVICE_SERIAL_PORT,44,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_4X				CTL_CODE(FILE_DEVICE_SERIAL_PORT,45,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_CLOCK				CTL_CODE(FILE_DEVICE_SERIAL_PORT,46,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_CONFIG_REG		CTL_CODE(FILE_DEVICE_SERIAL_PORT,47,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_SAMPLE_RATE		CTL_CODE(FILE_DEVICE_SERIAL_PORT,48,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_RX_TRIGGER		CTL_CODE(FILE_DEVICE_SERIAL_PORT,49,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_TX_TRIGGER		CTL_CODE(FILE_DEVICE_SERIAL_PORT,50,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_AUTO485			CTL_CODE(FILE_DEVICE_SERIAL_PORT,51,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_4X				CTL_CODE(FILE_DEVICE_SERIAL_PORT,52,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_CLOCK				CTL_CODE(FILE_DEVICE_SERIAL_PORT,53,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_TX_WRITE_SIZE		CTL_CODE(FILE_DEVICE_SERIAL_PORT,54,METHOD_BUFFERED,FILE_ANY_ACCESS)
...
#define IOCTL_SERIALP_GET_CLK1XDTR		CTL_CODE(FILE_DEVICE_SERIAL_PORT,62,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_EXT_COUNT		CTL_CODE(FILE_DEVICE_SERIAL_PORT,63,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_EXT_COUNT		CTL_CODE(FILE_DEVICE_SERIAL_PORT,64,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_HARDWARE_RTSCTS		CTL_CODE(FILE_DEVICE_SERIAL_PORT,65,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_HARDWARE_RTSCTS		CTL_CODE(FILE_DEVICE_SERIAL_PORT,66,METHOD_BUFFERED,FILE_ANY_ACCESS)



#define FC2328PCI	0
#define FC2324PCI	1
#define FCIG2322PCI 2
#define FCIG4221PCI 3
#define FC4222PCI	4
#define FC4224PCI	5
