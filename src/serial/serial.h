...
#define SERIAL_RX_FIFO_DEFAULT          14
#define SERIAL_TX_FIFO_DEFAULT          64
...
#define IOCTL_SERIALP_ENABLE_AUTO485			CTL_CODE(FILE_DEVICE_SERIAL_PORT,44,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_DISABLE_AUTO485			CTL_CODE(FILE_DEVICE_SERIAL_PORT,45,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_SAMPLE_RATE		CTL_CODE(FILE_DEVICE_SERIAL_PORT,46,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_RX_TRIGGER		CTL_CODE(FILE_DEVICE_SERIAL_PORT,47,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_TX_TRIGGER		CTL_CODE(FILE_DEVICE_SERIAL_PORT,48,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_AUTO485			CTL_CODE(FILE_DEVICE_SERIAL_PORT,49,METHOD_BUFFERED,FILE_ANY_ACCESS)
...
#define IOCTL_SERIALP_ENABLE_ISOSYNC		CTL_CODE(FILE_DEVICE_SERIAL_PORT,50,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_DISABLE_ISOSYNC		CTL_CODE(FILE_DEVICE_SERIAL_PORT,51,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_ISOSYNC		CTL_CODE(FILE_DEVICE_SERIAL_PORT,52,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_SET_HARDWARE_RTSCTS		CTL_CODE(FILE_DEVICE_SERIAL_PORT,53,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_HARDWARE_RTSCTS		CTL_CODE(FILE_DEVICE_SERIAL_PORT,54,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_SERIALP_GET_AUTO485		CTL_CODE(FILE_DEVICE_SERIAL_PORT,55,METHOD_BUFFERED,FILE_ANY_ACCESS)
